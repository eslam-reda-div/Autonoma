"""Define the configurable parameters for the src.agent."""
...
from src.agent.agents.web_researcher import prompts


@dataclass(kw_only=True)
class Configuration:
    """The configuration for the src.agent."""

    system_prompt: str = field(
        default=prompts.SYSTEM_PROMPT,
        metadata={
            "description": "The system prompt to use for the agent's interactions. "
            "This prompt sets the context and behavior for the src.agent."
        },
    )
